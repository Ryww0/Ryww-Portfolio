        ...
        <div class="row col-12 pt-5 pb-5">
            <div class="col-6 d-flex flex-column justify-content-between pe-5">
                ...
                <ul class="d-flex justify-content-around ps-5 pe-5">
                    ...
                    <li class="under-link"><a href="https://www.linkedin.com/in/laurent-chaitas-891746158/"
    ...
    <section id="work" class="container mt500">
        ...
        <div class="pt-5 pb-5">
            ...
            <div class="row col-12 d-flex justify-content-between mb-5">
                <div id="w1"
                     class="row col-11 h50 outline d-flex align-items-center justify-content-between card-work-1">
                    <div class="w-auto">
            ...
            <div class="row col-12 d-flex justify-content-between mb-5">
                ...
                <div id="w2"
                     class="row col-11 h50 outline d-flex align-items-center justify-content-between flex-row-reverse card-work-1">
                    <div class="w-auto">
                        <h2>Pokedex</h2>
                    </div>
                    <div class="w-auto">
